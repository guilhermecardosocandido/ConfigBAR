...
# PAL1 P e PA10 PT - PA10 P e PAL1 PT
    ...
    elif (status.get('RSUPRE_230_CH8902_S.s') == 'Estado do ponto digital:on' and 
          status.get('RSUPRE_230_CH8906_S.s') == 'Estado do ponto digital:on') or \
         (status.get('RSUPRE_230_CH8904_S.s') == 'Estado do ponto digital:on' and 
          status.get('RSUPRE_230_CH8908_S.s') == 'Estado do ponto digital:on'):
